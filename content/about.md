...
subtitle: "Physicist | CTO, GM & Co-founder @ QPerfect"
showTableOfContents: true
---

## Profile

I am a physicist, quantum software architect, and entrepreneur based in Strasbourg, France. I co-founded [QPerfect](https://qperfect.io), where I am **CTO and General Manager**. QPerfect is a quantum software company building tools that accelerate the path to fault-tolerant quantum computing, from [MIMIQ](https://qperfect.io/mimiq/) (the world's most powerful virtual quantum computer) to [QLU](https://qperfect.io/qlu/) (a fault-tolerant compilation and error correction platform for neutral atom hardware).
...
- Architected and led the development of [MIMIQ](https://qperfect.io/mimiq/), a virtual quantum computer integrating statevector and matrix product state (MPS) engines.
- Leading the development of [QLU](https://qperfect.io/qlu/), a fault-tolerant compilation and real-time error correction middleware for neutral atom quantum processors.
...
**Postdoctoral Researcher**, Strasbourg, France
*Supervisors: Prof. Guido Pupillo and Prof. Nikolay V. Prokof'ev*
...
**Doctoral Researcher**, Strasbourg, France
*Supervisor: Prof. Guido Pupillo*
